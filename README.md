...
To build the final jar and optimize the calculationRateApplication application for production, run:
...
Then navigate to [http://localhost:38080](http://localhost:38080) in your browser.
