...
public class ReturnExceptionSetting {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "return_exception_setting_generator")
    @SequenceGenerator(name = "return_exception_setting_generator", sequenceName = "return_exception_setting_generator", allocationSize = 1)
    private Long id;
    ...
    @JoinTable(
        name = "return_exceptions_roads",
        joinColumns = {@JoinColumn(name = "return_exception_setting_id", referencedColumnName = "id")},
    ...
    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable(
        name = "return_exceptions_stations",
        joinColumns = {@JoinColumn(name = "return_exception_setting_id", referencedColumnName = "id")},
    ...
    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable(
        name = "return_exceptions_departments",
        joinColumns = {@JoinColumn(name = "return_exception_setting_id", referencedColumnName = "id")},
    ...
    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable(
        name = "return_exceptions_cargo_volumes",
        joinColumns = {@JoinColumn(name = "return_exception_setting_id", referencedColumnName = "id")},
    ...
    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable(
        name = "return_exceptions_cargo_classes",
        joinColumns = {@JoinColumn(name = "return_exception_setting_id", referencedColumnName = "id")},
    ...
    public Station getStationReturn() {
        return stationReturn;
    }

    public void setStationReturn(Station stationReturn) {
    ...
    public boolean equals(Object o) {
        ...
        ReturnExceptionSetting that = (ReturnExceptionSetting) o;
        return
            containsElements(roads, that.roads) &&
                ...
                Objects.equals(stationReturn, that.stationReturn) &&
