...
@Component({
  selector: 'jhi-begin-exception-copy',
  templateUrl: './begin-exception-copy.component.html',
  styleUrls: ['./begin-exception-copy.component.scss'],
})
export class BeginExceptionCopyComponent implements OnInit {
