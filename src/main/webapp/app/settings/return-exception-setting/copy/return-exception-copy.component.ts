...
@Component({
  selector: 'jhi-return-exception-copy',
  templateUrl: './return-exception-copy.component.html',
  styleUrls: ['./return-exception-copy.component.scss'],
})
export class ReturnExceptionCopyComponent implements OnInit {
